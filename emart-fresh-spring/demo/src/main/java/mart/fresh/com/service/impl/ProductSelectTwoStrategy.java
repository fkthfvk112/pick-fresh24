...
public class ProductSelectTwoStrategy implements ProductSearchStrategy{
	private final ProductRepository productRepository;
	private final ModelMapper modelMapper;

	public ProductSelectTwoStrategy(ProductRepository productRepository, ModelMapper modelMapper) {
