...
public interface ApplyManagerRepository extends JpaRepository<ApplyManager, Integer> {
    ...
    int requestApplyManager(@Param("memberId") String memberId, 
    ...
    @Transactional
    @Modifying
	@Query("UPDATE ApplyManager am "
	      + "SET am.isApplied = :isApplied "
